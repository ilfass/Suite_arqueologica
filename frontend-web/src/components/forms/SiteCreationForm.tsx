...
interface SiteCreationFormProps {
...
const SiteCreationForm: React.FC<SiteCreationFormProps> = ({
  onSubmit,
  onCancel,
  loading = false,
  projectId,
  ...
  const updateDocument = (index: number, field: keyof SiteFormData['associatedDocuments'][0], value: any) => {
    setFormData(prev => ({
      ...prev,
      ...
      <div className="bg-white rounded-lg w-full max-w-5xl max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-200 sticky top-0 bg-white z-10">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-xl font-semibold text-gray-900">🏛️ Crear Nuevo Sitio/Yacimiento Arqueológico</h3>
              <p className="text-sm text-gray-600 mt-1">
                Proyecto: {projectName} | Área: {areaName}
              </p>
            </div>
            <button
              onClick={onCancel}
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-3">
              ...
              <Button 
                ...
                disabled={loading}
              >
                {loading ? 'Creando...' : '🏛️ Crear Sitio/Yacimiento'}
              </Button>
            </div>
          </div>
        </div>
