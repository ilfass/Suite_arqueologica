-- ========================================
-- SCRIPT CORREGIDO PARA SOLUCIONAR PROBLEMAS DE SUPABASE
...
-- Verificar política de spatial_ref_sys
SELECT 
    schemaname,
    tablename,
    policyname,
...
📋 Acciones realizadas:
✅ Política de seguridad creada para spatial_ref_sys (tabla del sistema)
...
⚠️ IMPORTANTE:
- La tabla spatial_ref_sys es una tabla del sistema PostGIS
- Se creó una política de solo lectura para resolver el problema de seguridad
